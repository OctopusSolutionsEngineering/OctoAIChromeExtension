...
4. The HTML page must include the `api.js` script and call the `getDashboardConfig()` function to get the dashboard configuration.
5. The configuration returned by the `getDashboardConfig()` function includes:
