...
const platformPrompts = {
    ...
    argocd: 'Create a Git Connection called "Mock" with a random username and in the repository restrictions add the allowed repository "https://mockgit.octopus.com/*"\n\n---\n\nCreate an Argo CD Tag Update project called "My Argo CD Tag Update" with the slug "argo-cd-octopub"',
    argocdmanifest: 'Create a Git Connection called "Mock" with a random username and in the repository restrictions add the allowed repository "https://mockgit.octopus.com/*"\n\n---\n\nCreate an Argo CD Manifest Update project called "My Argo CD Manifest Update" with the slug "argo-cd-octopub-manifest"',
